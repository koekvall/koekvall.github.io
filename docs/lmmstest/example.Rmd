...
likelihood ratio, and Wald test statistics in a simulation. Data were generated
according to the model from the previous section assuming the null hypothesis
$(\sigma, \lambda_1, \lambda_2) = (1, 0, 0)$ (first plot) or $(1, 0.1, 0.1)$ 
(second figure).
